...
public class DisplayJourneyContainersController {
	
		private LogisticsCompany logisticCompany;
		private Session sessionModel;
		private DisplayJourneyContainersView view;
		private Journey key;
		...
		public DisplayJourneyContainersController(LogisticsCompany logisticCompany, Session session, int selectedRow) {
...
//						container.setAvailability(true);
		...
		public void setView(DisplayJourneyContainersView view) {
			this.view = view;
