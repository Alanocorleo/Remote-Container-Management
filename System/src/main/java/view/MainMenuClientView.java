...
/**
 * This class is responsible for displaying a window with client's main menu for the
 * clients. It extends JFrame to get advantage of the components that can be added to 
 * the window.
 */
...
public class MainMenuClientView extends JFrame {
    ...
    /**
	 * This constructor sets MainMenuClientController, and calls for GUI initialization
